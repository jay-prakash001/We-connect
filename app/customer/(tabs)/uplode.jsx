import { View, Text, TextInput, TouchableOpacity, ScrollView, StyleSheet, Alert, Image, Button, ActivityIndicator } from 'react-native'; import React, { useEffect, useState } from 'react'
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View>
        ...
        <TouchableOpacity style={[
          styles.submitButton,
          isLoading && styles.disabledButton, // Apply disabled style when loading
        ]} onPress={createPost} disabled={isLoading}>
          ...
          {isLoading ? (
            ...
            <Text style={styles.submitText}>Create Post {isLoading}</Text>
          )
